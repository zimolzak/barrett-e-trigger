...
The line wraps are causing problems.
...
-------------------------------------------------------------------------
----------------
--STEP 1: Get all outpatient and inpatient ICD9 and ICD10 codes fortobacco use/depEND ence
-------------------------------------------------------------------------
----------------
--
--=======================================================================================
...
-------------------------------------------------------------------------
-------------------
--STEP 1: Get all outpatient and inpatient ICD9 and ICD10 codes for tobacco use/depEND ence
-------------------------------------------------------------------------
-------------------
USE ' + @Library + ';
...
-------------------------------------------------------------------------
----------------
-- Getting the counts of ICD codes and the first and last date of ICD code
SELECT
' + @PatientKey + ','
IF isdate(@Ref_Date_Col_Name) = 1
BEGIN
...
-------------------------------------------------------------------------
----------------
-- Getting the counts of stop codes and the first and last date of stop codes
SELECT distinct
' + @PatientKey + ','
IF isdate(@Ref_Date_Col_Name) = 1
BEGIN
...
-------------------------------------------------------------------------
----------
--Getting all of the Health Factors counts and first and last date of each.
SELECT DISTINCT
' + @PatientKey + ', '
IF isdate(@Ref_Date_Col_Name) = 1
BEGIN
...
-- note the close parenthesis coming up.
SET @SQL04 = @SQL04 + '
)
-----------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------
